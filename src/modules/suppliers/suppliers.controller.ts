...
export class SuppliersController {
  ...
  @Get('fill')
  @ApiOperation({ summary: 'Permite crear una lista de nombre y clave de todos los proveedores' })
  @ApiOkResponse({status: 200,description: 'Proveedor Ok'})
  fill() {
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Permite obtener la información de un proveedor para editar' })
  @ApiOkResponse({status: 200,description: 'Proveedor Ok'})
