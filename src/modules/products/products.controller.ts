...
import { ApiBadRequestResponse, ApiBearerAuth, ApiForbiddenResponse, ApiNotAcceptableResponse, ApiOkResponse, ApiOperation, ApiTags } from '@nestjs/swagger';
...
export class ProductsController {
  ...
  @ApiBearerAuth()
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({ summary: 'Obtiene una lista de productos para llenar combobox o select' })
  @ApiOkResponse({status: 200,description: 'Producto Ok'})
  @ApiForbiddenResponse({description:'No está autorizado'})  
  ...
  @ApiTags('Public')
  @ApiOperation({ summary: 'Obtener lista de productos relacionados para uno la tienda' })
  @ApiOkResponse({status: 200,description: 'Producto Ok'})
  ...
  @ApiBearerAuth()
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({ summary: 'Obtener el detalle de un producto con sus existencias en el inventario' })
  @ApiOkResponse({status: 200,description: 'Producto Ok'})
  @ApiForbiddenResponse({description:'No está autorizado'})  
  ...
  @Get('shop/:id/:cant')
  @ApiTags('Public')
  @ApiOperation({ summary: 'Verifica si hay existencia disponible de un producto' })
  ...
  @Get('shop/:id')
  @ApiTags('Public')
  @ApiOperation({ summary: 'Obtener la información de un producto y cuenta las visitas' })
  @ApiOkResponse({status: 200,description: 'Producto Ok'})  
  ...
  @Post('info')
  @ApiTags('Public')
  @ApiOperation({ summary: 'Obtener información de los productos enviados en el cuerpo de la petición' })
  @ApiOkResponse({status: 200,description: 'Productos Ok',type:InfoProductsResponseDto})
  ...
  @Post('shop')
  @ApiTags('Public')
  @ApiOperation({ summary: 'Obtener la lista de productos con información básica' })
  @ApiOkResponse({status: 200,description: 'Producto Ok'})
  ...
  @ApiBearerAuth()
  @UseGuards(AuthGuard('jwt'))
  @ApiOperation({ summary: 'Modificar la prioridad de las imagenes de un producto' })
  @ApiOkResponse({status: 200,description: 'Ok'})
  @ApiForbiddenResponse({description:'No está autorizado'})
  ...
  @ApiOkResponse({status: 200,description: 'Ok'})
  @ApiForbiddenResponse({description:'No está autorizado'})
  addCategoryToProduct(@Param('id') id: string,@Body() body: UpdateCategoryProductDto){
  ...
  @ApiOkResponse({status: 200,description: 'Ok'})
  @ApiForbiddenResponse({description:'No está autorizado'})
  addSpecToProduct(@Param('id') id: string,@Body() body: UpdateSPecProductDto){
