...
export class UsersController {
    ...
    @Get()
    @ApiOperation({ summary: 'Permite obtener una lista de todos los usuarios registrados' })
    ...
    @Get('admin/fill')
    @ApiOperation({ summary: 'Permite obtener una lista de todos los usuarios administativos' })
    @ApiOkResponse({status: 200,description: 'Usuarios Ok'})
    fill() {
    ...
    @Get('roles')
    @ApiOperation({ summary: 'Permite obtener una lista de todos los roles disponibles para usuarios' })
    @ApiOkResponse({status: 200,description: 'Usuarios Ok'})
    fillRoles() {
    ...
    @Get('status')
    @ApiOperation({ summary: 'Permite obtener una lista de los estados de los usuarios' })
    @ApiOkResponse({status: 200,description: 'Usuarios Ok'})
    fillStatus() {
    ...
    @Get('password/:id')
    @ApiOperation({ summary: 'Permite generar una contraseña aleatoria para un usuario' })
    @ApiOkResponse({status: 200,description: 'Usuarios Ok'})
    ...
    @Get(':id')
    @ApiOperation({ summary: 'Permite obtener la información de un usuario para edición' })
    @ApiOkResponse({status: 200,description: 'Usuarios Ok'})
    getOne(@Param() params){
